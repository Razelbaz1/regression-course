...
הריפו מאגד את כל חומרי התרגול של קורס בטיחות למהנדסים באוניברסיטת אריאל, סמסטר אביב 2026. בתוכו: 12 מצגות אינטראקטיביות לפי סדר השיעורים, מחברות Jupyter עם הקוד והדוגמאות הנלוות, וקבצי דאטה לתרגול עצמי.
...
עובדים עם **JupyterLab** בשפת **Python**.
